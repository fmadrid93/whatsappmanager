  ...
  template: `
    <main class="page flow-page">
      ...
      <p-card header="Flujos registrados" styleClass="flow-table">
        <p-table [value]="flows()" [tableStyle]="{ 'min-width': '900px' }">
          ...
          <ng-template #body let-flow><tr>
            <td><strong>{{ flow.name }}</strong><div class="muted">{{ flow.description || 'Sin descripción' }}</div></td>
