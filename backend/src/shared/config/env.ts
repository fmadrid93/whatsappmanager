...
const schema = z.object({
  ...
  SESSION_SUPERVISOR_INTERVAL_MS: z.coerce.number().int().positive().default(1000),
  ...
  SEND_DELAY_MIN_MS: z.coerce.number().int().nonnegative().default(10000),
  SEND_DELAY_MAX_MS: z.coerce.number().int().nonnegative().default(22000),
